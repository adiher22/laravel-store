    ...
    <div class="section-content section-dashboard-home" data-aos="fade-up">
      <div class="container-fluid">
        <div class="dashboard-heading">
          <h2 class="dashboard-title">#STORE09101120</h2>
                    ...
                    <div class="col-12 col-md-8">
                      <div class="row">
                        <div class="col-12 col-md-6">
                          ...
                          <div class="product-subtitle">Adi Hernawan</div>
                        </div>
                        <div class="col-12 col-md-6">
                        ...
                        <div class="col-12 col-md-6">
                          ...
                          <div class="product-subtitle">12, Oktober 2020</div>
                        </div>
                        <div class="col-12 col-md-6">
                        ...
                        <div class="col-12 col-md-6">
                          ...
                          <div class="product-subtitle">$120,900</div>
                        </div>
                        <div class="col-12 col-md-6">
                          <div class="product-title">Mobile</div>
                          <div class="product-subtitle">+628 4226 9787</div>
                        </div>
                      </div>
                    ...
                    <div class="col-12">
                      <div class="row">
                        <div class="col-12 col-md-6">
                          ...
                          <div class="product-subtitle">Setra Dutra Centra</div>
                        </div>
                        <div class="col-12 col-md-6">
                          <div class="product-title">Address 2</div>
                          <div class="product-subtitle">Bekasi, Cikarang Selatan.</div>
                        </div>
                        <div class="col-12 col-md-6">
                        ...
                        <div class="col-12 col-md-6">
                          ...
                          <div class="product-subtitle">17533</div>
                        </div>
                        <div class="col-12 col-md-6">
